...
const BasicCuration = (props) => {
  ...
  return (
    <div className='basic_curation_wrap'>
      ...
      <br />
      {/* 베스트 영화? */}
      <div id='whole_movie' className='basic_curation_component'>
        <div
      ...
      <hr />
      {/* 추천 장르 영화 */}
      <div id='whole_genre' className='basic_curation_component'>
      ...
      <hr />
      {/* 추천 감독 영화 */}
      <div id='whole_director' className='basic_curation_component'>
        <div className='basic_curation_subject'>
          <br />
          <span>
            모두가 주목하는 감독
      ...
      <hr />
      {/* 추천 배우 영화 */}
      <div id='whole_actor' className='basic_curation_component'>
        <div className='basic_curation_subject'>
          <br />
          <span>
            모두가 주목하는 배우
